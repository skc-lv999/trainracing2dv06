            ...
            {(() => {
              ...
              return (
                <>
                  ...
                  {stationScrollX > -2200 && stationScrollX < 7500 && (
                    <div 
                      id="station-platform-block"
                      className="absolute bottom-11 h-16 bg-slate-800 border-x-2 border-t-2 border-slate-600 flex flex-col justify-between z-0 shadow-2xl text-slate-200 pointer-events-none w-[6000px] overflow-hidden rounded-t-lg"
                      style={{ left: `${stationScrollX - 5800}px` }}
                    >
                      ...
                      <div className="relative flex-1 bg-gradient-to-b from-slate-900/95 to-slate-950/95 border-b border-slate-800 overflow-hidden">
                        {(() => {
                          const isVisible = (relativeX: number) => {
                            const screenX = stationScrollX - 5800 + relativeX;
              ...
              {(() => {
                ...
                return (
                  <div 
                    ...
                    className="absolute bottom-0 h-7 z-20 flex items-end pointer-events-none w-[6000px] overflow-hidden"
                    style={{ left: `${stationScrollX - 5800}px` }}
                  >
                    ...
                    {Array.from({ length: 15 }).map((_, carIdx) => {
                      ...
                      const screenX = stationScrollX - 5800 + 6000 - 378 - carOffset;
